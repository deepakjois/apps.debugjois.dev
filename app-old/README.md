...
Archived previous TanStack Start app. It remains available for reference while
the replacement in `../app` settles, but repository deployment automation no
longer builds or deploys this directory.
...
# Historical Deployment Packaging

`../infra/deploy.sh --with-artifact` now packages `../app`, not this archived app.
